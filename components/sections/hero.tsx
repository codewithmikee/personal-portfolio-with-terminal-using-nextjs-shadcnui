    ...
    <section id="hero" className="min-h-screen flex items-center justify-center pt-16">
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <Image
              src={personal.avatar || "/placeholder.svg?height=150&width=150&query=professional developer avatar"}
              alt={personal.name}
              width={150}
              height={150}
          ...
          <h2 className="text-xl md:text-2xl text-muted-foreground mb-8 text-balance">{personal.title}</h2>

          <p className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto text-pretty">{personal.bio}</p>
